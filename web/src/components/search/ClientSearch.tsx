  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="mb-8 max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold tracking-tight text-center text-gray-900 dark:text-white sm:text-4xl mb-4">
          Search Posts
        </h1>
        <input
          type="search"
          ...
          className="w-full px-4 py-2 text-lg border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
        />
      </div>
